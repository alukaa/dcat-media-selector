...
function getFileType(suffix) {
    ...
    var result = '',
        ...
        img_list = [
            ...
            'png', 'pnm', 'pnt', 'pntg', 'ppm', 'qti', 'qtif', 'ras', 'rgb', 'svg', 'tif', 'tiff', 'wbmp', 'xbm', 'xpm', 'xwd', 'svg', 'webp'
        ],
        // 匹配音频
...
function rightTableHtml() {
    ...
    html += '<li class="dropdown-item"><a class="media_selector_batch_delete"><i class="feather icon-trash"></i> 刪除</a></li>';
    html += '<li class="dropdown-item"> <a class="media_selector_batch_mobile"><i class="fa fa-arrows-h"></i> 移動 </a></li>';
    html += '</ul>';
    html += '</div>';
